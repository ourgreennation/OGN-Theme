 ...
 *
 * @package WordPress
 * @subpackage Our Green Nation Theme
 */
?>
</div><!-- #main .wrapper -->
</div><!-- #page -->
		    ...
		    <div class="footer-inner-bottom">
		        <div class="footer-inner">
		            ...
		            <div id="footer-links">
						...
						<p class="footer-disclaimer">Disclaimer: This site does not provide medical, dietary, financial, or legal advice. It is for informational purposes only.</p>
